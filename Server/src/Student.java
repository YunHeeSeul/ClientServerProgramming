...
public class Student implements Serializable{
    ...
    public boolean checkSID(String studentID) {return this.studentID.equals(studentID);}
    ...
    public boolean matchSC(String studentID, String completedCourseID) {
        if(this.checkSID(studentID))
            if(this.completedCourseList.contains(completedCourseID)) return true;
        return false;
    }
